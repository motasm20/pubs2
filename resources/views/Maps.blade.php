...
<ul class="links">
    ...
    <main>
        <h1>kies een map</h1>
        <div class="container">
            <a href="/Maps/Split"><img class="Maps" src="{{asset('/img/Split.png')}}" alt="Split-Map"></a>
            <a href="/Maps/Bind"><img class="Maps" src="{{asset('/img/Bind.png')}}" alt="Bind-Map"></a>
            <a href="/Maps/Haven"><img class="Maps" src="{{asset('/img/Haven.png')}}" alt="Haven-Map"></a>
        </div>
    </main>
    <footer>
